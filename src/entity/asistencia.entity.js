...
import UserSchema from "./user.entity.js"; // Verifica que el archivo tenga la exportación adecuada
...
const AsistenciaSchema = new EntitySchema({
    ...
    relations: {
        personal: {
            type: "many-to-one",
            target: "User", // Asegúrate de que el nombre coincida con el nombre de la entidad `UserSchema`
            joinColumn: {
